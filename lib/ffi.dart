...
class SearchFFI {
  ...
  SearchFFI(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  SearchFFI.fromLookup(
  ...
  ffi.Pointer<ffi.Char> tantivy_last_error() {
    return _tantivy_last_error();
  }

  late final _tantivy_last_errorPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
        'tantivy_last_error',
      );
  late final _tantivy_last_error = _tantivy_last_errorPtr
      .asFunction<ffi.Pointer<ffi.Char> Function()>();

  void tantivy_free_str(ffi.Pointer<ffi.Char> s) {
    return _tantivy_free_str(s);
  }

  late final _tantivy_free_strPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'tantivy_free_str',
      );
  late final _tantivy_free_str = _tantivy_free_strPtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();

  int tantivy_init(ffi.Pointer<ffi.Char> dir_path) {
    return _tantivy_init(dir_path);
  }

  late final _tantivy_initPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char>)>>(
        'tantivy_init',
      );
  late final _tantivy_init = _tantivy_initPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>)>();

  int tantivy_add_doc(ffi.Pointer<ffi.Char> text_ptr) {
    return _tantivy_add_doc(text_ptr);
  }

  late final _tantivy_add_docPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char>)>>(
        'tantivy_add_doc',
      );
  late final _tantivy_add_doc = _tantivy_add_docPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> tantivy_search(
    ffi.Pointer<ffi.Char> query_ptr,
    int top_k,
  ) {
    return _tantivy_search(query_ptr, top_k);
  }

  late final _tantivy_searchPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>, ffi.Int)
        >
      >('tantivy_search');
  late final _tantivy_search = _tantivy_searchPtr
